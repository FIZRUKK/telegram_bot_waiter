...
book_button = InlineKeyboardMarkup(inline_keyboard=[
    ...
    [InlineKeyboardButton(text = 'Забронировать', callback_data=f'booking_new'), 
...
booking_yes_no = InlineKeyboardMarkup(inline_keyboard=[
    ...
    [InlineKeyboardButton(text='Одобрить', callback_data='yes_book'), 
    InlineKeyboardButton(text='Отказать', callback_data='no_book')]

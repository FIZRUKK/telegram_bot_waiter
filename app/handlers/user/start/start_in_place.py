...
import app.keyboards.main_buttons as kb_start_in_place
...
async def start_in_caffe(message: Message, command: CommandObject, state: FSMContext):
    ...
    await message.answer_photo(photo=phot_id, caption=text, reply_markup=kb_start_in_place.start_in_place)
...
async def back_main_menu_in_cafe(callback: CallbackQuery):
    ...
    await callback.message.edit_media(media, reply_markup=kb_start_in_place.start_in_place)
...
async def exit_in_cafe(callback: CallbackQuery, state: FSMContext):
    ...
    await callback.message.edit_caption(caption=text, 
                                        reply_markup=kb_start_in_place.start_in_home_button)
